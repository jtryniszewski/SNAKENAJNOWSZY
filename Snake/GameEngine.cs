...
namespace Snake
{
    public class GameEngine
    {
        ...
        private List<GUIElement> GetMusicOffMenuHardButton()
        {

            return new List<GUIElement>()
            {
                getGUIElement("background",0,0,null),
                getGUIElement("MuzykaWyl",0,-200,()=>TurnOn()),
                getGUIElement("return",0,100,()=>wroc()),
                getGUIElement("Hard", 0, -100, ()=>LevelHardToEasy()),
            };
        }
        private List<GUIElement> GetMusicOffMenuEasyButton()
        {
            ...
            return new List<GUIElement>()
            {
                ...
                getGUIElement("MuzykaWyl",-0,-200,()=>TurnOn()),
                getGUIElement("return",-0,100,()=>wroc()),
                getGUIElement("Easy", 0, -100, ()=>LevelEasyToHard()),
            };
        }
        private List<GUIElement> GetOptionMenuHardButton()
        {
            return new List<GUIElement>()
            {
                getGUIElement("background",0,0,null),
                getGUIElement("MuzykaWl",0,-200,()=>TurnOff()),
                getGUIElement("return",0,100,()=>wroc()),
                getGUIElement("Hard", 0, -100, ()=>LevelHardToEasy()),
            };
        }
        private List<GUIElement> GetOptionMenuEasyButton()
        {
            return new List<GUIElement>()
            {
                getGUIElement("background",0,0,null),
        ...
        private List<GUIElement> GetHighMenu()
        {
            return new List<GUIElement>()
            {
               getGUIElement("background",0,0,null),
                ...
                getGUITextElement(900,200,null,"Score:"),
                getGUITextElement(200,300,null,ListLoad),
            };
        ...
        public void LevelEasyToHard()
        {
            ...
            if (isMusic == true)
            {
                menu = new Menu(this, GetOptionMenuHardButton());
            }
            else
            {
                menu = new Menu(this, GetMusicOffMenuHardButton());
            }
        }
        public void LevelHardToEasy()
        {
            Thread.Sleep(100);
            speed = 100;
            isEasy = true;
            ...
            if (isMusic == true)
            {
                menu = new Menu(this, GetOptionMenuEasyButton());
            }
            else
            {
                menu = new Menu(this, GetMusicOffMenuEasyButton()); ;
            }
        }
        ...
        {
            if (isMusic == true && isEasy == true)
            {
                menu = new Menu(this, GetOptionMenuEasyButton());
            }
            else if (isMusic == false && isEasy == true)
            {
                menu = new Menu(this, GetMusicOffMenuEasyButton());
            }
            else if (isMusic == true && isHard == true)
            {
                menu = new Menu(this, GetOptionMenuHardButton());
            }
            else if (isMusic == false && isHard == true)
            {
                menu = new Menu(this, GetMusicOffMenuHardButton());
            }
        }
        ...
        public void Initialize(ContentManager content, SpriteBatch spriteBatch)
        {
            ...
            if (!File.Exists(path) || new FileInfo("Highscore.txt").Length == 0)
            {
                ...
                {
                    int y = 42 - (element.nick.Length + element.points.ToString().Length);
